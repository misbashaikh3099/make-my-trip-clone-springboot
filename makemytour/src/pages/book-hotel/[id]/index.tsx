  ...
  useEffect(() => {
    const fetchHotel = async () => {
      try {
        ...
        const filteredata=data.filter((hotels:any)=>hotels.id===id);
        setHotel(filteredata);
      } catch (error) {
        console.error(error);
      } finally {
        setLoading(false);
      ...
      <div className="grid gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2 text-black">
            ...
            <Input id="availableRooms" value={hotels.availableRooms} readOnly />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Hotel Title & Rating */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold mb-2 text-black">{hotels.hotelName}</h1>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="col-span-2 relative group cursor-pointer">
                ...
                />
                <div className="absolute bottom-4 left-4 bg-white/90 px-3 py-1 rounded-full flex items-center space-x-1 text-black">
          ...
          <div className="lg:col-span-1 text-black">
            ...
            {/* Rating Card */}
            <div className="bg-white rounded-xl shadow-lg p-6 mt-6 text-black">
              <div className="flex items-center justify-between mb-4">
