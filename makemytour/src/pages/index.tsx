...
import SearchSelect from "@/components/SearchSelect"; // ✅ Added
import {
  HomeIcon,
  Hotel,
  Plane,
...
export default function Home() {
  ...
  const hotelData = [
    { id: 1, name: "Luxury Palace", location: "Mumbai", price: 15000 },
    { id: 2, name: "Comfort Inn", location: "Delhi", price: 8000 },
    { id: 3, name: "Seaside Resort", location: "Goa", price: 12000 },
    { id: 4, name: "Mountain View Hotel", location: "Shimla", price: 10000 },
  ];
  const offers = [
    {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      try {
        const fetchedHotelData = await gethotel();
        sethotel(fetchedHotelData);
  ...
  if (bookingtype === "flights") {
    ...
    console.log("Search Flight Results:", results); // ✅ for debugging flights
    ...
    console.log("Search Hotel Results:", results); // ✅ for debugging hotels
    setsearchresult(results);
  }
};
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl shadow-lg mx-auto max-w-5xl p-6 ">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="col-span-1">
              <SearchInput
                icon={<Users className="text-black-400" />}
                ...
                {searchresults.map((result) => (
                  ...
                  >
                    {bookingtype === "flights" ? (
                      ...
                      <>
                      <h3 className="font-semibold text-lg text-black">{result.hotelName}</h3>
                      <p className="text-gray-600 text-black">City: {result.location}</p>
                      <p className="text-gray-600 text-black">
                      ...
                      onClick={() => handlebooknow(result.id)}>Book Now</Button>
                    </>
